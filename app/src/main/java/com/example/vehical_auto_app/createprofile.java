...
public class createprofile extends AppCompatActivity {
    ...
    EditText edname,edaddress,edcontact,editem1,editem1price,editem2,editem2price,edtime,ednumber,edrent;
    String lati,longi;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String carmodel = editem1.getText().toString().trim();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Task<Uri> downloadurl =taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                ...
                                newpost.child("Carno").setValue(carmodel);
    ...
    private void sharedata(String name, String key) {
